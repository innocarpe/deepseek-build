...
| 2 | **Ultragoal `goals.json` story status** (local `.omc/…/goals.json`) | Which story is next *in this machine’s ledger* |
| 3 | **[MASTER_PLAN.md](./MASTER_PLAN.md)** | Final goal, waves, SemVer bands |
| 4 | **Wave PRD** `prd/PRD-wave-*.md` | Exit criteria for a wave |
| 5 | **Fixed PR DAG** `WAVE_A_PR_DAG.md` / `WAVE_B_PR_DAG.md` | Unit split for a wave |
| 6 | **RELEASE_TRAIN_0x.md** | Wave A narrative detail only (not Wave B+) |
| 7 | Cold-start prompts | Session bootstrap text |
