...
| 2026-09-26 | **`6.1.4`** Tighten the frame: the prompt echo takes one minimal pad on all four sides, block text starts at the accent column, turn timestamps close on the band edge, the phone band shows cache N%, and one blank floor row sits under the bottom status row. | PR #_(fill in)_ |
