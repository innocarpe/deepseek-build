...
//! DeepSeek Night v2, the classic/neutral DeepSeek skins, GrokNight,
//! TokyoNight, RosePineMoon and OscuraMidnight share `grok-night.tmTheme`; GrokDay uses `grok-day.tmTheme` with deepened colors for light backgrounds.
//!
