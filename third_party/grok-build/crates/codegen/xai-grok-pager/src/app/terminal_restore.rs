...
pub(super) fn set_panic_hook() {
    ...
    panic::set_hook(Box::new(move |info| {
        ...
        // Product teardown order: the mouse/paste reset must remain last so a
        // panicking agent shutdown cannot leave mouse reporting or bracketed
        // paste enabled in the user's shell.
