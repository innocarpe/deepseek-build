...
fn click_settings_breadcrumb_after_nav_reverts_to_original() {
    ...
    // Pick a different index. The picker catalog starts with `auto` at index 0 and `deepseeknight-v2` at index 1;
    // choose the other entry to ensure we're navigating to a different value.
